(defstructure (fiserale (:include db-agent (program 'fiserale-program) (body (make-fiserale-agent-body)) (name "fiserale")) ) 
    "An agent good enough to defeat EVIL computer agents")

(defstructure (fiserale-agent-body (:include db-agent-body (name "fiserale")(sname "F9A"))))
