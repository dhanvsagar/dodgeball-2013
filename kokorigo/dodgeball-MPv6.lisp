...
(if(and 
        (> soucasnavzdalenost -1)  
        (>= soucasnavzdalenost (my-agent-body-poslednivzdalenost agent-body)) 
        (> (my-agent-body-poslednivzdalenost agent-body) -1) 
   )


(setf (my-agent-body-kolbezpriblizeni agent-body) 
      (+ (my-agent-body-kolbezpriblizeni agent-body) 1)   )

(setf (my-agent-body-kolbezpriblizeni agent-body) 0)

)

(setf (my-agent-body-poslednivzdalenost agent-body) soucasnavzdalenost)
...
(if(and (not (object-contents agent-body))
        nearesttoball
(<
(my-agent-body-kolbezpriblizeni agent-body) 
5
)
        (null (aref percept 
