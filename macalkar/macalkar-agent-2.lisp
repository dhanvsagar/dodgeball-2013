...
(defconstant macalkar-agent-1-name "mac1")
(defconstant macalkar-agent-2-name "mac2")
(defconstant macalkar-agent-3-name "mac3")

(defconstant macalkar-agents-names (list macalkar-agent-1-name macalkar-agent-2-name macalkar-agent-3-name))
...
(defstructure
	(macalkar-body-1
		(:include db-agent-body
			(name macalkar-agent-1-name)
			(sname macalkar-agent-1-name))))

(defstructure
	(macalkar-body-2
		(:include db-agent-body
			(name macalkar-agent-2-name)
			(sname macalkar-agent-2-name))))

(defstructure
	(macalkar-body-3
		(:include db-agent-body
			(name macalkar-agent-3-name)
			(sname macalkar-agent-3-name))))
